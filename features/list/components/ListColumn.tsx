        ...
        >
            {(provided) => (
                <li
                    ...
                    className={`list-none flex-none flex flex-col bg-white rounded-xl max-h-full ${column.isFold ? 'w-14 min-w-14 max-w-14 items-center px-0 py-3' : 'w-72 min-w-72 max-w-72'}`}
                >
